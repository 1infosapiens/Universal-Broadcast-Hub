...
import { TrendingUp, CheckCircle2, Briefcase, BookOpen, ArrowRight } from "lucide-react";

const modules = [
  "Entrepreneurship & Innovation", "Business Planning & Strategy", "International Trade & Finance",
  "Cross-Cultural Management", "Venture Capital & Funding", "E-Commerce & Digital Business",
  "Supply Chain & Logistics", "Leadership & Negotiation", "Accounting & Financial Management",
  "Global Marketing",
];

const careers = [
  "Entrepreneur / Founder", "International Business Manager", "Business Development Officer",
  "Trade Analyst", "Start-up Consultant", "Investment Analyst", "Export/Import Manager",
];

const programs = [
  { title: "Certificate in Entrepreneurship", duration: "6 Months", type: "Certificate" },
  { title: "Diploma in International Business", duration: "1 Year", type: "Diploma" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              <div className="bg-background rounded-2xl p-7 border border-border shadow-lg">
                <h3 className="font-bold text-primary text-lg mb-6 flex items-center gap-2"><TrendingUp className="w-5 h-5 text-secondary" /> Programme Options</h3>
