...
import { BarChart2, CheckCircle2, Briefcase, BookOpen, ArrowRight } from "lucide-react";

const modules = [
  "Principles of Project Management", "Project Planning & Scheduling", "Risk Management",
  "Quality Assurance & Control", "Agile & Scrum Methodologies", "Budget & Cost Management",
  "Stakeholder Management", "PRINCE2 & PMP Frameworks", "Leadership & Team Dynamics",
  "Project Monitoring & Evaluation",
];

const careers = [
  "Project Manager", "Programme Manager", "Agile Scrum Master", "Operations Manager",
  "Construction Project Lead", "NGO/Development Programme Officer", "Consultant",
];

const programs = [
  { title: "Certificate in Project Management", duration: "6 Months", type: "Certificate" },
  { title: "Diploma in Project Management", duration: "1 Year", type: "Diploma" },
  { title: "BA in Project Management", duration: "3 Years", type: "Degree" },
];

export default function ProjectManagementProgramme() {
  return (
    <div>
      <Hero
        title="Project Management (BA)"
        subtitle="Plan, lead, and deliver — develop the skills to drive successful outcomes across any industry."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  Project Management at UnibUni prepares students with both the strategic thinking and the operational know-how to lead complex projects from inception to delivery. Students learn internationally recognised frameworks and methodologies, making them competitive for project management roles across sectors — from technology and construction to NGOs and creative industries.
                </p>
              </div>
              <div>
            ...
            <div className="space-y-6">
              <div className="bg-background rounded-2xl p-7 border border-border shadow-lg">
                <h3 className="font-bold text-primary text-lg mb-6 flex items-center gap-2"><BarChart2 className="w-5 h-5 text-secondary" /> Programme Options</h3>
